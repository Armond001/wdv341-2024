...
$sql = "SELECT product_image, product_name, product_description, product_price, product_status, product_inStock FROM `wdv341_products` ORDER BY product_name  DESC";
